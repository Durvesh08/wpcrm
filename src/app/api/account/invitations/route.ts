...
//   on the list falls through to the wpcrm-wine.vercel.app fallback with a
...
//
// Previous implementation hard-defaulted to `https://wpcrm-wine.vercel.app`
...
function getBaseUrl(request: Request): string {
  ...
  return "https://wpcrm-wine.vercel.app";
}
